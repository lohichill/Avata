...
echo '<form id="form" action="tao.php" method="GET"><button class="chat"/>Tạo Clan mới</button></form>';
}
if($dv['id'] >= 1) {
echo '<div class="lucifer"><a href="/nhom/bxh.php"><b>Bảng Xếp Hạng Clan</b></a></div>';
...
$nhom = nhom($res['id']);
echo '<div class="omenu"><img class="avatar_vina" src="/avatar/'.$nhom['user_id'].'.png" alt="" /><a href="page.php?id='.$res['id'].'"><b><font color="2c5170">'.$nhom['name'].'</font><img src="'.$home.'/images/clan/'.$nhom['icon'].'.png"></b></a><br/>'.catchu($nhom['gt'],0,10).'<br/><br/></div>';
}
if($dem > 10)
...
<tbody><tr><td width="48px;" class="blog-avatar"><img class="avatarforum" src="../avatar/'.$nhom[user_id].'.png"></td><td style="vertical-align: bottom;"><table cellpadding="0" cellspacing="0"><tbody>
<tr><td class="current-blog" rowspan="2" style=""><div class="blog-bg-left"><img src="/theme/HoangThuan/images/left-blog.png"></div><a href="/member/'.$nhom[user_id].'.html"><b> '.(time()>$xx[lastdate]+300?'<img style="vertical-align:middle;" src="/images/off.png">':'<img style="vertical-align:middle;" src="/images/on.png">').' </b></a><b><a href="/member/'.$nhom[user_id].'.html"><b><span style="color:#ff1234">'.$chunhom[name].'<span style="color:#ff1234;"> - Hội Trưởng</span></span></b></a></b><div class="text"><a href="page.php?id='.$nhom[id].'"><b><font color="2c5170"><img src="/images/clan/'.$nhom[icon].'.png" alt="icon nhóm"> - '.$nhom[name].'</font></b></a><br>'.$nhom[gt].'</div></td></tr></tbody></table></td></tr></tbody></table></div>';
}
if($dem > 10)
